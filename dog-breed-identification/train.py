...
parser.add_argument('--model',type=str,default="vgg16",help='choose model betweenvgg16,densenet169 or alexnet (default: vgg16)')
...
def trainning(save_path,modl,output_lay,hidden_layer,dropout,device,learn_rate,epochs,pathdir,chekpoint):
    ...
    loss,epoc=train_model(epochs,dataloaders,device,criterion,optimizer,Model,current_epoch)   
    print("\n ************Testing session************** \n")
